 ...
 * @param arguments: arguments (if any) protain的话就没有arguments了
 * @param parentIndex: Int, pointer to parent structure (e.g. event, if argument) 如果candidate是argument 那么parent就是event
