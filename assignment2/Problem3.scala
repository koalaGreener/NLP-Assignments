...
object Problem3Triggers {
  ...
  def main(args: Array[String]) {
    ...
    // read the specifications of the method for different subsampling 二次抽样 thresholds 门槛
    ...
    val triggerWeights = PrecompiledTrainers.trainPerceptron(triggerTrain, triggerModel.feat, triggerModel.predict, 12)
...
object Problem3Arguments {
  def main (args: Array[String] ) {
    ...
    val argumentWeights = PrecompiledTrainers.trainPerceptron(argumentTrain,argumentModel.feat,argumentModel.predict,12)
